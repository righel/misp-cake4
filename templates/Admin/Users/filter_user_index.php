<div class="events">
    <?php echo $this->Form->create(null, ['url' => ['controller' => 'users', 'action' => 'filterUserIndex']]); ?>
    <fieldset>
        ...
        <div class="overlay_spacing">
            ...
            foreach ($simpleFilters as $t) {
                if ($t == 'role') {
                    echo $this->Form->select('search' . $t, array(
                        'options' => array($roles),
                        'label' => false,
                        'class' => 'input-large',
    ...
    <div class="overlay_spacing">
        ...
        <?php echo $this->Form->create(null, ['id' => 'test', 'url' => $baseurl . '/admin/users/index']); ?>
        <fieldset>
            <?php
        ...
        <div id="generatedURL" style="word-wrap: break-word;"><br /><?php echo __('Save this URL if you would like to use the same filter settings again'); ?><br />
            <div style="background-color:#f5f5f5;border: 1px solid #e3e3e3; border-radius:4px;padding:3px;background-color:white;"><span id="generatedURLContent"></span></div>
        </div>
        <br />

...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var here = '<?= ltrim($this->request->getAttribute('here'), '/') ?>';
        ...
        $(`#toggleFilterButton-${randomValue}`)
            ...
            .click(function() {
                const url = `/${here}/filtering`
                const reloadUrl = `/${here}${additionalUrlParams}`
        ...
        function doFilter($button) {
            ...
            const url = `/${here}${additionalUrlParams}?quickFilter=${encodedFilters}`

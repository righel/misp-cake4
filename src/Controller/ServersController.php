...
class ServersController extends AppController
{
    ...
    public function add()
    {
        ...
        $orgs = $this->Servers->Orgs->find('list', ['limit' => 200]);
        $remoteOrgs = $this->Servers->RemoteOrgs->find('list', ['limit' => 200]);
        $this->set(compact('server', 'orgs', 'remoteOrgs'));
    }
